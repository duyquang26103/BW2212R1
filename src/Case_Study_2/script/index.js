...
function handleCarousel() {
    const NEW_BOOK_ITEMS = document.querySelectorAll('#newCarousel .carousel-item');
...
function removeBackDrop() {
    const header = document.getElementsByClassName('sticky-top');
    header[0].style.backdropFilter = 'none';
}

function addBackDrop() {
    const header = document.getElementsByClassName('sticky-top');
    header[0].style.backdropFilter = " blur(15px)";
}
    ...
    JXSlider.prototype = {
        ...
        _onLoaded: function () {
            ...
            if (this.imgBefore && this.imgBefore.loaded === true &&
                ...
                setText(this.projectName, 'Quang Vương');
